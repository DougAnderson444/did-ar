import{_ as y}from"./preload-helper-aa6bc0ce.js";import{e as f}from"./_page-a60ee6d0.js";const w=null,h=[],v=["#key-0","#key-1"],p=[],g=[],m=[],A=[],M=[],l={"@context":["https://www.w3.org/ns/did/v1","https://w3id.org/security/suites/ed25519-2018/v1"],id:w,verificationMethod:h,authentication:v,assertionMethod:p,keyAgreement:g,capabilityInvocation:m,capabilityDelegation:A,service:M},b=`export async function handle(state, action) {\r
